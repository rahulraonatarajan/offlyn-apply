...
RAW_BASE="https://raw.githubusercontent.com/joelnishanth/offlyn-apply/feat/graph-memory-layer/scripts/native-host"
SETUP_BASE="https://raw.githubusercontent.com/joelnishanth/offlyn-apply/feat/graph-memory-layer/scripts/setup-ollama"
